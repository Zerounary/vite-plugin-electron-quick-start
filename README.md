Boilerplate for [vite-plugin-electron](https://www.npmjs.com/package/vite-plugin-electron)
...
Vue3 + Vite + electron18 + vitest + pinia + vue-router4 + commitizen + windicss + electron-store + electron-log
